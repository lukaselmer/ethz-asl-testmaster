class Scenario < ActiveRecord::Base
  ...
  validates :execution_multiplicity, :execution_multiplicity_per_machine, numericality: { only_integer: true, greater_than_or_equal_to: 1, less_than_or_equal_to: 10 }, if: -> (s) { s.test_run }
